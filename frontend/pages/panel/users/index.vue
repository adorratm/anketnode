            ...
            <div class="col-lg-12">
              <div class="card card-refresh">
                ...
                <div class="card-body">
                  <BackendDatatable
                    :dataurl="
                      $config.API_URL + 'v1/backend/usersController/datatable'
                    "
                    :rankurl="
                      $config.API_URL + 'v1/backend/usersController/rank/'
                    "
                    :isactiveurl="
                      $config.API_URL + 'v1/backend/usersController/isactive/'
                    "
                    :editurl="'/panel/users/update/'"
                    :deleteurl="$config.API_URL + 'v1/panel/users/delete/'"
  ...
  data() {
    return {
      columns: [
        ...
        {
          label: this.$i18n.t("panel.users.firstName"),
          field: "first_name",
          html: true,
          type: "string",
        },
        {
          label: this.$i18n.t("panel.users.lastName"),
          field: "last_name",
          html: true,
          type: "string",
        },
        {
          label: this.$i18n.t("panel.users.email"),
          field: "email",
          html: true,
          type: "string",
        },
        {
          label: this.$i18n.t("panel.users.phone"),
          field: "phone",
          html: true,
          type: "string",
        },
