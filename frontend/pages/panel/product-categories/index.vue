                ...
                <div class="card-header card-header-action">
                  ...
                  <div class="d-flex align-items-center">
                    <nuxt-link
                      ...
                      to="/panel/product-categories/add"
                      >{{ $t("panel.createNew") }}</nuxt-link
                    >
                  </div>
                </div>
                <div class="card-body">
                  <BackendProductCategoriesContent :rankurl="
                      $config.API_URL + 'v1/backend/productCategoriesController/rank/'
                    " :deleteurl="$config.API_URL+'v1/panel/productcategories/delete/'" :isactiveurl="
                      $config.API_URL +
  ...
  data() {
    return {
      columns: [
        ...
        {
          label: this.$i18n.t("panel.productCategories.title"),
          field: "title",
          html: true,
          type: "string",
        },
